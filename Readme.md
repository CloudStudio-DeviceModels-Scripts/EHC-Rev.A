...
# Configuration Script – EHC - Rev. A

This **Configuration** script is designed for the **EHC** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EHC Rev. A

Este script de **Configuration** está diseñado para el modelo **EHC** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
